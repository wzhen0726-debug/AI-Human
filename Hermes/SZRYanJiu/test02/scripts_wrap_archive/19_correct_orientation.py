...
OUT_BLEND = os.path.join(ROOT, "output", "tripo_tpose_corrected.blend")
...
bbox = get_bbox(mesh_obj)
print(f"绕X轴+90°后: X={bbox['size'].x:.3f} Y={bbox['size'].y:.3f} Z={bbox['size'].z:.3f}")

# ============================================================
# Step 2: 绕Z轴+90° (正面朝-Y)
# ============================================================
print("\n" + "="*60)
print("Step 2: 绕Z轴+90° (正面朝-Y)")
print("="*60)
