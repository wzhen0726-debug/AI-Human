...
OUT_BLEND = os.path.join(ROOT, "output", "landmark_scene_matrix.blend")

print("="*60)
print("使用matrix_basis直接旋转")
print("="*60)
...
# 应用到matrix_basis
mesh_obj.matrix_basis = rot_z @ mesh_obj.matrix_basis
...
bbox = get_bbox(mesh_obj)
print(f"\n最终: 高={bbox['size'].z:.2f}m, 宽={bbox['size'].x:.2f}m, 深={bbox['size'].y:.2f}m")
