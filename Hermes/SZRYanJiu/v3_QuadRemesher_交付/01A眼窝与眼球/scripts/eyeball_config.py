...
EYE_PUSH_BACK = 0.020      # +Y=头内=后移. 2026-08-07定量: 原始眼睑apex y=-0.1149(L)/-0.1160(R),
                           # 角膜前极应在眼睑后≈apex-2mm, 球心y≈-0.1004. 拟合球心-0.1202+0.020=-0.1002.
                           # 之前从-0.1202一路往前调到-0.1142方向全反, 用户确认太靠外(-Y太多), 需后移.
