...
scene.camera=cam; cam.data.type='ORTHO'; cam.data.ortho_scale=0.08
cam.location=Vector((c.x-0.15, c.y, c.z)); cam.rotation_euler=(c-cam.location).to_track_quat('-Z','Y').to_euler()
scene.render.filepath=r"E:\WangZhen_Project\AI\ShuZiRen\Hermes\SZRYanJiu\v3_QuadRemesher_交付\01A眼窝与眼球\screenshots\socket_profile.png"
