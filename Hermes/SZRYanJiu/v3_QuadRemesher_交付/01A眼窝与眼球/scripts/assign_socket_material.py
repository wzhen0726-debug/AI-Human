...
HI = os.path.join(S01A, "输出", "01_1_eye_socket.blend")
OUT = os.path.join(S01A, "_中间", "01_1_eye_socket_qr.blend")
...
if _tag_path:
    ...
    _cJ = _json2.load(open(os.path.join(S01A, "3ddfa", "eyelid_contour_manual.json"), encoding="utf-8"))
...
_cont_p = os.path.join(S01A, "3ddfa", "eyelid_contour_manual.json")
