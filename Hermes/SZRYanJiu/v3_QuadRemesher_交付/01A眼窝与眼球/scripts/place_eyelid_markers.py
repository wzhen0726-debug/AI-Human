...
OUT_BLEND = os.path.join(S01A, "输出", "01A_markers_eyelid.blend")
...
# ===== 打印图例(用户对照) =====
print("\n" + "=" * 62)
print("打点要求: 标记点贴住【可见睑缘】—上睑=紧贴睫毛根所在的睑缘线; 不要放到双眼皮褶线/眉下/眼窝骨缘上.")
print("  放偏大 → 眼裂开口变大、眼白露多、眼球显凸; 放偏小 → 眼球被眼睑盖住过多. 12点沿睑缘均匀分布, 内外眼角各1点.")
print("=" * 62)
